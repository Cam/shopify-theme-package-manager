...
// Wait for package.json to appear with retries

export async function waitForPackageJson(pkgRoot, retries = 5, delay = 200) {
...
/**
 * Normalizes spacing in a file:
 * - Removes leading/trailing blank lines
 * - Collapses multiple blank lines into one
 */
export async function normalizeFileSpacing(filePath) {
